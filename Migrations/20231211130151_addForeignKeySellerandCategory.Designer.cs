<<<<<<<< HEAD:Migrations/20231211130151_addForeignKeySellerandCategory.Designer.cs
﻿// <auto-generated />
using System;
...
namespace App_Dev_1670.Migrations
{
    ...
    [Migration("20231211130151_addForeignKeySellerandCategory")]
    partial class addForeignKeySellerandCategory
    {
        /// <inheritdoc />
...
{
    [DbContext(typeof(ApplicationDatabase))]
    [Migration("20231213212710_updateDatabaseBaseOnERD")]
    partial class updateDatabaseBaseOnERD
    {
        /// <inheritdoc />
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App_Dev_1670.Models.User", b =>
                {
            ...
            modelBuilder.Entity("App_Dev_1670.Models.Book", b =>
                {
                    ...
                    b.HasOne("App_Dev_1670.Models.User", "Seller")
                        .WithMany("SellBooks")
                        .HasForeignKey("SellerID")
            ...
            modelBuilder.Entity("Cart", b =>
                {
                    ...
                    b.HasOne("App_Dev_1670.Models.User", null)
                        .WithMany()
...
>>>>>>>> a8f2e274b68d90f2bfb690a815c8ca6508ac7621:Migrations/20231213212710_updateDatabaseBaseOnERD.Designer.cs
