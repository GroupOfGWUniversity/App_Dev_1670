        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FrontBookUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BackBookUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserBook", x => new { x.BooksInCartBookID, x.ListOfCustomersId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserBook_AspNetUsers_ListOfCustomersId",
                        column: x => x.ListOfCustomersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserBook_Books_BooksInCartBookID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserBook_ListOfCustomersId",
